package com.rkl.common_library.widgets;

/**
 * 主要功能：修改过的FragmentTabHost,保存fragment实例不销毁
 ...
 */
public class UnrefreshFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public UnrefreshFragmentTabHost(Context context) {
    ...
    public UnrefreshFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                  ft.attach(newTab.fragment);
    ...
    public class Tab {
        ...
        public Tab(Class fragment,int selectorTitle, int selectorIcon ) {
