...
public class RegexUtils {
    ...
    public static boolean isZHNumber(CharSequence input) {
        return isMatch(Constant.REGEX_ZH_NUMBER, input);
    }
    /**
     * 验证URL
     *
    ...
    public static boolean isURL(CharSequence input) {
        return isMatch(Constant.REGEX_URL, input);
    }
    ...
    public static boolean isUsername(CharSequence input) {
        return isMatch(Constant.REGEX_USERNAME, input);
    }
