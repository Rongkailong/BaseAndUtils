...
/**
 * 主要功能:沉浸式状态栏的工具类 author by：labie
 * gitub:https://github.com/laobie/StatusBarUtil
 * Created by wz on 2017/3/20
 * 修订历史:
 */
public class StatusBarUtil {
    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    public static final int MAX_STATUS_BAR_ALPHA = 255;
    public static final int MIN_STATUS_BAR_ALPHA =0 ;
