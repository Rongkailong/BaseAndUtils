...
public class ScreenRotateUtil {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 888&&mActivity!=null) {
...
//                    LogUtils.d("onSensorChanged","..........1");
                    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE);
                    isLandscape = true;
                } else if (orientation > 135 && orientation < 225) {
//                    LogUtils.d("onSensorChanged","..........2");
                    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
                    isLandscape = false;
                } else if (orientation > 225 && orientation < 315) {
//                    LogUtils.d("onSensorChanged","..........3");
                    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                    isLandscape = true;
                } else if ((orientation > 315 && orientation < 360) || (orientation > 0 && orientation < 45)) {
//                    LogUtils.d("onSensorChanged","..........4");
    ...
    public class OrientationSensorListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
             ...
             * 要是禁用了就直接返回
             */
            if(isEffetSysSetting&&mActivity!=null){
                try {
...
//                Log.d(TAG, "onSensorChanged: 发送消息");
...
//        LogUtils.d("onSensorChanged",".........."+(isLandscape?"切换成竖屏":"切换成横屏"));
        final Activity mActivity = mActivityReference.get();
        if(mActivity==null){
            return;
        }
    ...
    public void stop() {
        ...
        mActivityReference = null;  // 防止内存泄漏
    }
    ...
    public void toggleRotate() {
         ...
         * 如果开启了重力i感应就需要修改状态
         */
        isOpenSensor = false;//手动的修改状态需要关闭重力感应去修改状态
