package com.rkl.common_library.recyclerview.adapter;

import android.content.Context;
import android.support.v7.widget.RecyclerView;
import android.view.View;
import android.view.ViewGroup;
import com.rkl.common_library.recyclerview.base.ItemViewDelegate;
import com.rkl.common_library.recyclerview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder>
{
    ...
    public void replaceDataAll(List<T> data) {
        if (data!=null){
            clearData();
            mDatas.addAll(data);
            notifyDataSetChanged();
